...
<div class="jumbotron text-center">
  ...
  <p>Criando infraestruturas Autônomas</p> 
  <!--  
  <form>
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      ...
      <h4>A idéia é fazer um bate papo técnico e político da construção de <em>Redes Comunitárias</em> com o objetivo de democratizar o acesso a comunicação e apropriação tecnológica dos processos</h4><br>
        
    </div>
        <div class="col-sm-4">
         <img reclass="img-sponsive"  src="/img/apropria.png" alt="apropria" width="350" height="300">
...
<div class="container-fluid bg-grey">
  <div class="row">
    <div class="col-sm-4">
    <img reclass="img-sponsive" class="img-rounded" src="/img/mesh.png" alt="apropria" width="394" height="195">
    ...
    <div class="col-sm-4">
      ...
      <h4>Utilizar roteadores domésticos com protocolos (BATMAN E BMX ) para viabilizar uma topologia mesh. Fazemos isso modificando os roteadores e colocando um novo firmware criado através do Libremesh. 
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>Visita Técnica aos povos Wapichan na Guiana, selva e Internet!
      ...
      <div class="item">
        ...
        <p><a href="blog/#cupula" target=“_blank” class="alert-lnik"> saiba mais.</a></h4></p>
      </div>
      <div class="item">
        <h4>Mais sobre projetos da Coolab</h4>
      </div>
    </div>
